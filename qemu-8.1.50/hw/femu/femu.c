                            ...
                            Error **errp)
{
    ...
    snprintf(ret->ssd_read_count, 50, "%ld", fc->ssd->read_count);
    snprintf(ret->ssd_write_count, 50, "%ld", fc->ssd->write_count);
    snprintf(ret->ssd_erase_count, 50, "%ld", fc->ssd->erase_count);
