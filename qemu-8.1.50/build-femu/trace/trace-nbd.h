...
static inline void _nocheck__trace_nbd_send_request(uint64_t from, uint32_t len, uint64_t cookie, uint16_t flags, uint16_t type, const char * name)
{
...
static inline void trace_nbd_send_request(uint64_t from, uint32_t len, uint64_t cookie, uint16_t flags, uint16_t type, const char * name)
{
    if (true) {
...
static inline void _nocheck__trace_nbd_receive_structured_reply_chunk(uint16_t flags, uint16_t type, const char * name, uint64_t cookie, uint32_t length)
{
...
static inline void trace_nbd_receive_structured_reply_chunk(uint16_t flags, uint16_t type, const char * name, uint64_t cookie, uint32_t length)
{
    if (true) {
        _nocheck__trace_nbd_receive_structured_reply_chunk(flags, type, name, cookie, length);
    }
}
...
static inline void _nocheck__trace_nbd_co_send_simple_reply(uint64_t cookie, uint32_t error, const char * errname, int len)
{
...
static inline void trace_nbd_co_send_simple_reply(uint64_t cookie, uint32_t error, const char * errname, int len)
{
    if (true) {
...
static inline void _nocheck__trace_nbd_co_send_chunk_read(uint64_t cookie, uint64_t offset, void * data, size_t size)
{
...
static inline void trace_nbd_co_send_chunk_read(uint64_t cookie, uint64_t offset, void * data, size_t size)
{
    if (true) {
...
static inline void _nocheck__trace_nbd_co_send_chunk_read_hole(uint64_t cookie, uint64_t offset, size_t size)
{
...
static inline void trace_nbd_co_send_chunk_read_hole(uint64_t cookie, uint64_t offset, size_t size)
{
    if (true) {
...
static inline void _nocheck__trace_nbd_co_receive_request_payload_received(uint64_t cookie, uint32_t len)
{
...
static inline void trace_nbd_co_receive_request_payload_received(uint64_t cookie, uint32_t len)
{
    if (true) {
