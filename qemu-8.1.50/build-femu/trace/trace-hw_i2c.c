...
uint16_t _TRACE_I2C_MCTP_TX_START_SEND_DSTATE;
uint16_t _TRACE_I2C_MCTP_TX_SEND_BYTE_DSTATE;
uint16_t _TRACE_I2C_MCTP_TX_DONE_DSTATE;
uint16_t _TRACE_I2C_MCTP_HANDLE_CONTROL_DSTATE;
uint16_t _TRACE_I2C_MCTP_UNHANDLED_CONTROL_DSTATE;
uint16_t _TRACE_I2C_MCTP_DROP_INVALID_LENGTH_DSTATE;
uint16_t _TRACE_I2C_MCTP_DROP_INVALID_PEC_DSTATE;
uint16_t _TRACE_I2C_MCTP_DROP_INVALID_EID_DSTATE;
uint16_t _TRACE_I2C_MCTP_DROP_INVALID_PKTSEQ_DSTATE;
uint16_t _TRACE_I2C_MCTP_DROP_SHORT_PACKET_DSTATE;
uint16_t _TRACE_I2C_MCTP_DROP_EXPECTED_SOM_DSTATE;
...
TraceEvent _TRACE_I2C_MCTP_TX_START_SEND_EVENT = {
    .id = 0,
    .name = "i2c_mctp_tx_start_send",
    .sstate = TRACE_I2C_MCTP_TX_START_SEND_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_TX_START_SEND_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_TX_SEND_BYTE_EVENT = {
    .id = 0,
    .name = "i2c_mctp_tx_send_byte",
    .sstate = TRACE_I2C_MCTP_TX_SEND_BYTE_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_TX_SEND_BYTE_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_TX_DONE_EVENT = {
    .id = 0,
    .name = "i2c_mctp_tx_done",
    .sstate = TRACE_I2C_MCTP_TX_DONE_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_TX_DONE_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_HANDLE_CONTROL_EVENT = {
    .id = 0,
    .name = "i2c_mctp_handle_control",
    .sstate = TRACE_I2C_MCTP_HANDLE_CONTROL_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_HANDLE_CONTROL_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_UNHANDLED_CONTROL_EVENT = {
    .id = 0,
    .name = "i2c_mctp_unhandled_control",
    .sstate = TRACE_I2C_MCTP_UNHANDLED_CONTROL_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_UNHANDLED_CONTROL_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_DROP_INVALID_LENGTH_EVENT = {
    .id = 0,
    .name = "i2c_mctp_drop_invalid_length",
    .sstate = TRACE_I2C_MCTP_DROP_INVALID_LENGTH_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_DROP_INVALID_LENGTH_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_DROP_INVALID_PEC_EVENT = {
    .id = 0,
    .name = "i2c_mctp_drop_invalid_pec",
    .sstate = TRACE_I2C_MCTP_DROP_INVALID_PEC_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_DROP_INVALID_PEC_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_DROP_INVALID_EID_EVENT = {
    .id = 0,
    .name = "i2c_mctp_drop_invalid_eid",
    .sstate = TRACE_I2C_MCTP_DROP_INVALID_EID_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_DROP_INVALID_EID_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_DROP_INVALID_PKTSEQ_EVENT = {
    .id = 0,
    .name = "i2c_mctp_drop_invalid_pktseq",
    .sstate = TRACE_I2C_MCTP_DROP_INVALID_PKTSEQ_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_DROP_INVALID_PKTSEQ_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_DROP_SHORT_PACKET_EVENT = {
    .id = 0,
    .name = "i2c_mctp_drop_short_packet",
    .sstate = TRACE_I2C_MCTP_DROP_SHORT_PACKET_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_DROP_SHORT_PACKET_DSTATE 
};
TraceEvent _TRACE_I2C_MCTP_DROP_EXPECTED_SOM_EVENT = {
    .id = 0,
    .name = "i2c_mctp_drop_expected_som",
    .sstate = TRACE_I2C_MCTP_DROP_EXPECTED_SOM_ENABLED,
    .dstate = &_TRACE_I2C_MCTP_DROP_EXPECTED_SOM_DSTATE 
};
TraceEvent *hw_i2c_trace_events[] = {
    ...
    &_TRACE_I2C_MCTP_TX_START_SEND_EVENT,
    &_TRACE_I2C_MCTP_TX_SEND_BYTE_EVENT,
    &_TRACE_I2C_MCTP_TX_DONE_EVENT,
    &_TRACE_I2C_MCTP_HANDLE_CONTROL_EVENT,
    &_TRACE_I2C_MCTP_UNHANDLED_CONTROL_EVENT,
    &_TRACE_I2C_MCTP_DROP_INVALID_LENGTH_EVENT,
    &_TRACE_I2C_MCTP_DROP_INVALID_PEC_EVENT,
    &_TRACE_I2C_MCTP_DROP_INVALID_EID_EVENT,
    &_TRACE_I2C_MCTP_DROP_INVALID_PKTSEQ_EVENT,
    &_TRACE_I2C_MCTP_DROP_SHORT_PACKET_EVENT,
    &_TRACE_I2C_MCTP_DROP_EXPECTED_SOM_EVENT,
  NULL,
};
