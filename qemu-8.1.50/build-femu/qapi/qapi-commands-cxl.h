...
void qmp_cxl_add_dynamic_capacity(const char *path, CXLDCExtentRecordList *extents, Error **errp);
void qmp_marshal_cxl_add_dynamic_capacity(QDict *args, QObject **ret, Error **errp);
void qmp_cxl_release_dynamic_capacity(const char *path, CXLDCExtentRecordList *extents, Error **errp);
