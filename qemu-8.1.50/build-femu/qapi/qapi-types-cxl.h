...
typedef struct CXLDCExtentRecord CXLDCExtentRecord;

typedef struct CXLDCExtentRecordList CXLDCExtentRecordList;
...
void qapi_free_CXLDCExtentRecord(CXLDCExtentRecord *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CXLDCExtentRecord, qapi_free_CXLDCExtentRecord)

struct CXLDCExtentRecordList {
    CXLDCExtentRecordList *next;
    CXLDCExtentRecord *value;
};

void qapi_free_CXLDCExtentRecordList(CXLDCExtentRecordList *obj);
G_DEFINE_AUTOPTR_CLEANUP_FUNC(CXLDCExtentRecordList, qapi_free_CXLDCExtentRecordList)

struct q_obj_cxl_add_dynamic_capacity_arg {
    char *path;
    CXLDCExtentRecordList *extents;
};
